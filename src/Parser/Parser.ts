        ...
        performAction: function anonymous(yytext: any, yyleng: any, yylineno: any, yy: any, yystate: any /* action[1] */, $$: any /* vstack */, _$: any /* lstack */
            ...
            switch (yystate) {
                ...
                case 3: this.$ = new Imp($$[$0-2], $$[$0]);
                    break;
                case 4: this.$ = new Or($$[$0-2], $$[$0]);
                    break;
                case 5: this.$ = new And($$[$0-2], $$[$0]);
                    break;
                case 6: this.$ = new Not($$[$0]);
                    break;
                case 7: this.$ = $$[$0-1];
                    break;
                case 8: this.$ = new Atom(yytext);
                    break;
                case 9: this.$ = new True();
                    break;
                case 10: this.$ = new False();
                    break;
            }
        },
        table: [{3:1,4:2,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{1:[3]},{5:[1,8],6:[1,9],7:[1,10],8:[1,11],9:[1,12]},{4:13,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{4:14,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{5:[2,8],6:[2,8],7:[2,8],8:[2,8],9:[2,8],12:[2,8]},{5:[2,9],6:[2,9],7:[2,9],8:[2,9],9:[2,9],12:[2,9]},{5:[2,10],6:[2,10],7:[2,10],8:[2,10],9:[2,10],12:[2,10]},{1:[2,1]},{4:15,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{4:16,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{4:17,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{4:18,10:[1,3],11:[1,4],13:[1,5],14:[1,6],15:[1,7]},{5:[2,6],6:[2,6],7:[2,6],8:[2,6],9:[2,6],12:[2,6]},{6:[1,9],7:[1,10],8:[1,11],9:[1,12],12:[1,19]},{5:[2,2],6:[1,9],7:[1,10],8:[1,11],9:[1,12],12:[2,2]},{5:[2,3],6:[2,3],7:[1,10],8:[1,11],9:[1,12],12:[2,3]},{5:[2,4],6:[2,4],7:[2,4],8:[1,11],9:[1,12],12:[2,4]},{5:[2,5],6:[2,5],7:[2,5],8:[2,5],9:[1,12],12:[2,5]},{5:[2,7],6:[2,7],7:[2,7],8:[2,7],9:[2,7],12:[2,7]}],
